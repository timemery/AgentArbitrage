...
- **Still to come under this same bump:** the thin-peak-season minimum (a season with too few distinct price points is persisted with `List_at` NULL, **never deleted** — §7.8). Its minimum and window width are being chosen from `audit_list_at_sources.py` section (d).
