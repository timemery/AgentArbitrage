...
4.  **Logging:** Enhanced logging to capture the exact context of AI rejections for future debugging.

## Technical Details
*   **Linear Regression:** Used `scipy.stats.linregress` to calculate the slope of price over time.
*   **Prompt Engineering:** The prompt now explicitly states "3-Year Trend: UP/DOWN/FLAT (+X%)" and "3-Year Average Price: $Y".
