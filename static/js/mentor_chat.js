document.addEventListener('DOMContentLoaded', function() {
    const MENTORS = {
        'olyvia': { name: 'Olyvia', role: 'CFO Advisor', avatar: 'big_Olivia.png', small: 'small_Olivia.png', tiny: 'tiny_Olivia.png', intro: "Olivia is a seasoned financial advisor specializing in online arbitrage and Amazon scaling. She excels at identifying high-margin, low-risk opportunities while fiercely protecting capital and minimizing exposure." },
