...
imports = ('keepa_deals.Keepa_Deals', 'keepa_deals.tasks', 'keepa_deals.simple_task', 'keepa_deals.backfiller', 'keepa_deals.recalculator', 'keepa_deals.sp_api_tasks', 'keepa_deals.env_diag', 'keepa_deals.diag_task')
